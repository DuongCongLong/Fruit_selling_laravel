        ...
        <div class="card-header">
          <div class="row">
            <div class="col-12 text-right">
              <a href="{{route('admin.post.create')}}" class="btn btn-success">Thêm
                <i class="fas fa-plus"></i>
            </a>
            <a href="{{route('admin.post.trash')}}" class="btn btn-danger">Thùng rác
              ...
              <tr>
                ...
                <td class="text-center" style="width:100px"><img src="{{asset('images/posts/'.$row->image)}}"  class="img img-fluid" alt="{{$row->image}}"></td>
                    ...
                    <td class="text-center" style="width:220px">
                      @if ($row->status==1)
                      <a href="{{route('admin.post.status', $args)}}" class='btn btn-success'>
                        <i class="fas fa-toggle-on"></i>
                    </a>
                      @else
                      <a href="{{route('admin.post.status', $args)}}" class='btn btn-danger'>
                      ...
                      @endif
                        ...
                        <a href="{{route('admin.post.edit', $args)}}" class='btn btn-primary'>
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="{{route('admin.post.delete', $args)}}" class='btn btn-danger'>
                            <i class="fas fa-trash"></i>
                        </a>
                    </td>
