...
<div class="container">
    <nav class="biolife-nav">
        <ul>
            ...
            <li class="nav-item"><span>Thành viên mới? <a href="{{route('addUser')}}">Đăng ký</a> tại đây.</span>
        </ul>
    </nav>
</div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="signin-container">
                        <form action="{{route('website.dologin')}}" method="post">
                            @csrf
                            <p class="form-row">
                                <label for="fid-name">Email hoặc tên người dùng:<span class="requite">*</span></label>
                            ...
                            <p class="form-row">
                                ...
                                <input type="password" name="password" id="password" value="{{ old('password') }}" class="txt-input" placeholder="Vui lòng nhập mật khẩu của bạn">
                                @error('password')
                                    <span class="error-message" style="color: red;">{{ $message }}</span>
                                @enderror
                            </p>                            
                            <p class="form-row wrap-btn">
                                <button class="btn btn-submit btn-bold" name="DANGNHAP" type="submit">Đăng nhập</button>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="register-in-container">
                        <div class="intro">
                            ...
                            <a href="{{route('signup')}}" class="btn btn-bold">ĐĂNG KÝ TÀI KHOẢN</a>
                        </div>
                    </div>
                </div>                    
            </div>
