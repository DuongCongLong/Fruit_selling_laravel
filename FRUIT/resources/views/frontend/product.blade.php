                    ...
                    <div class="product-category list-style">
                        ...
                        <div class="product-related-box single-layout">
                            <div class="biolife-title-box lg-margin-bottom-26px-im">
                                ...
                                <span class="subtitle">Sản phẩm tốt nhất dành cho bạn</span>
                                <h3 class="main-title">Tất cả sản phẩm</h3>
                            </div>
                        ...
                        <div class="widget price-filter biolife-filter">
                            ...
                            <div class="wgt-content">
                                <div class="frm-contain">
                                    <form action="{{ route('filters') }}" name="price-filter" id="price-filter" method="get">
                                        <p class="f-item">
