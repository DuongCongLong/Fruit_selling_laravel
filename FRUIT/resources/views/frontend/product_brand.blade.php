                    ...
                    <div class="product-category list-style">
                        ...
                        <div id="top-functions-area" class="top-functions-area" >
                            <div class="flt-item to-left group-on-mobile">
                                {{-- <span class="flt-title">Tinh chỉnh</span>
                                        ...
                                        <form action="#" name="frm-refine" method="get">
                                            ...
                                            <div data-title="Giá:" class="selector-item">
                                                <select name="price" class="selector">
                                                    ...
                                                    <option value="class-1st">Dưới 5đ</option>
                                                    <option value="class-2nd">5-10đ</option>
                                                    <option value="class-3rd">10-20đ</option>
                                                    <option value="class-4th">20-45đ</option>
                                                    <option value="class-5th">45-100đ</option>
                                                    <option value="class-6th">100-150đ</option>
                                                    <option value="class-7th">Trên 150đ</option>
                                                </select>
                                            </div>
                                            <div data-title="Thương hiệu:" class="selector-item">
                                                <select name="brad" class="selector">
                                                    <option value="all">Thương hiệu hàng đầu</option>
                                                    <option value="br2">Thương hiệu thứ nhất</option>
                                                    <option value="br3">Thương hiệu thứ hai</option>
                                                    <option value="br4">Thương hiệu thứ ba</option>
                                                    <option value="br5">Thương hiệu thứ tư</option>
                                                    <option value="br6">Thương hiệu thứ năm</option>
                                                </select>
                                            </div>
                                            <p class="btn-for-mobile"><button type="submit" class="btn-submit">Tìm kiếm</button></p>
                                        </form>
                                    </div>              --}}
                            </div>
                        ...
                        <div class="widget biolife-filter">
                            ...
                            <div class="wgt-content">
                                <ul class="check-list multiple">
                                    <li class="check-list-item"><a href="#" class="check-link">Giá trị hữu cơ</a></li>
                                    <li class="check-list-item"><a href="#" class="check-link">Plum Organic</a></li>
                                    <li class="check-list-item"><a href="#" class="check-link">Giao tận nhà</a></li>
                                </ul>
                            </div>
                        </div>
